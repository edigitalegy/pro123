...
function createCustomButtons(option) {
  const buttonData = {
      1: { id: "0btnpretest", icon: "bi-clipboard-check", text: "الاختبار القبلي" ,time:"2:00"},
...
{
  if(button.id === "0btnpretest"){ window.open("./pre_test.html", '_self'); }
  if(button.id === "0btnposttest"){ window.open("./post_test.html", '_self');}
