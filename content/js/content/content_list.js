...
const lesson1 = " جلسات الانتباه التلقائي للصوت (الانتباه السمعي)";
const lesson2 = "جلسات التمييز السمعي";
const lesson3 = "جلسات التعرف السمعي (الفهم والاستيعاب)";
const lesson4 = "جلسات التذكر السمعي (الذاكرة السمعية)";
const lesson5 = "جلسات التتابع السمعي (التسلسل والربط)";
const lesson6 = "جلسات الاغلاق والتداعي السمعي ";
